...
# Convert the flattened index into a 2D index
        ...
        if possible_star(sub):
            ...
            print("fwhm ", self.fwhm, self.last_fwhm_mean)
            self.fwhm_mean = self.fwhm_mean + self.fwhm
            self.fwhm_count = self.fwhm_count + 1
            if (self.fwhm_count == 100):
                self.last_fwhm_mean = self.fwhm_mean/self.fwhm_count
                self.updateplot(self.last_fwhm_mean)
                self.fwhm_count = 0
                self.fwhm_mean = 0
...
if __name__ == "__main__":
    ...
    parser.add_argument("-exp", type=float, default = 0.01, help="exposure in seconds (default 0.0su1)")
    ...
    parser.add_argument("-crop", "--crop", type=float, default = 0.3, help="crop ratio")
